...
const SubmittedReports: React.FC = () => {
  ...
  // Fetch all reports from Supabase using React Query for automatic updates
  ...
  const handleStatusChange = async (reportId: string, newStatus: string) => {
    try {
      ...
      // We'll refetch automatically through the real-time subscription
      toast({
  ...
  const handleViewDetails = (report: Report) => {
    // Store report details in session storage to access on the detail page
